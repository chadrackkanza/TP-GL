...
import com.example.minibazaar.ProductsCategory.LaptopsActivity;
import com.example.minibazaar.ProductsCategory.ShirtsActivity;
import com.example.minibazaar.ProductsCategory.ShoesActivity;
import com.example.minibazaar.ProductsCategory.SmartphonesActivity;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void inflateNavDrawer() {
        ...
        PrimaryDrawerItem item5 = new PrimaryDrawerItem().withIdentifier(6).withName(R.string.logout).withIcon(R.drawable.logout);
        ...
        result = new DrawerBuilder()
                ...
                .addDrawerItems(item1,item2,item4,item6,item5, new DividerDrawerItem(), item8,new DividerDrawerItem()).withOnDrawerItemClickListener(new Drawer.OnDrawerItemClickListener() {
                    @Override
                    public boolean onItemClick(View view, int position, IDrawerItem drawerItem) {
                        ...
                        switch (position){
                            ...
                            case 7:
                                ...
                                Toast.makeText(MainActivity.this, "Travail de G.L fait par NYEMBO LUKUSA DEV, MUKONKI KASANDA LEOPOLD, MUGANGANE FULANO MARCEL, NATHAN MULONDA LEANDRE", Toast.LENGTH_LONG).show();

                                break;

                            case 10:
                                new EasyFeedback.Builder(MainActivity.this)
                                        .withEmail("chadrackkanza2015@gmail.com")
                                        .withSystemInfo()
                                        .build()
                                        .start();
                                break;
    ...
    private void inflateImageSlider() {
        ...
        slideModels.add(new SlideModel("https://m.media-amazon.com/images/G/31/img19/Wireless/Apple/iPhone11/RiverImages/11Pro/IN_iPhone11Pro_DESKTOP_01._CB437064827_.jpg", null, null));
        slideModels.add(new SlideModel("https://piunikaweb.com/wp-content/uploads/2019/08/oneplus_7_pro_5g_experience_the_power_of_5g_banner-750x354.jpg", null, null));
        slideModels.add(new SlideModel("https://lh3.googleusercontent.com/RSyeouwiFX4XVq6iw3H94al0VcXD693tBy2MxhBKCxAHCIfIpdt7wDV47_j2HanPSnTli7JgZ0fYHxESjz0uvVgeCBT3=w1000", null, null));
        slideModels.add(new SlideModel("https://i.pinimg.com/originals/b2/78/7c/b2787cea792bff7d2c33e26ada6436bb.jpg", null, null));
        slideModels.add(new SlideModel("https://cdnb.artstation.com/p/assets/images/images/016/802/459/large/shuja-shuaib-banner.jpg?1553535424", null, null));
    ...
    private void tapview() {
        ...
        new TapTargetSequence(this)
                .targets(
                        ...
                        TapTarget.forView(findViewById(R.id.view_profile), "Profil", "Vous pouvez voir et modifier votre profil ici !")
                                .targetCircleColor(R.color.colorAccent)
                                .titleTextColor(R.color.colorAccent)
                                .titleTextSize(25)
                                .descriptionTextSize(15)
                        ...
                        TapTarget.forView(findViewById(R.id.cart), "Votre panier", "Voici le raccourci vers votre panier !")
                                .targetCircleColor(R.color.colorAccent)
                                .titleTextColor(R.color.colorAccent)
                                .titleTextSize(25)
                                .descriptionTextSize(15)
                        ...
                        TapTarget.forView(findViewById(R.id.visitingcards), "Categories", "Les catégories de produits ont été répertoriées ici!")
                                .targetCircleColor(R.color.colorAccent)
                                .titleTextColor(R.color.colorAccent)
                                .titleTextSize(25)
                                .descriptionTextSize(15)
                ...
                .listener(new TapTargetSequence.Listener() {
                    ...
                    public void onSequenceFinish() {
                        //session.setFirstTime(false);
                        Toasty.success(MainActivity.this, "Vous êtes prêt à partir !", Toast.LENGTH_SHORT).show();
                    }
    ...
    public void calendarsActivity(View view) {
        ...
        startActivity(new Intent(MainActivity.this, SmartphonesActivity.class));
    ...
    public void keychainsActivity(View view) {
        ...
        startActivity(new Intent(MainActivity.this, LaptopsActivity.class));

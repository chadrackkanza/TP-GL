...
public class SmartphonesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      //  if (mRecyclerView != null) {
       ...
       // }
        ...
        Query query = firebaseFirestore.collection("Products").document("101").collection("Smartphones");
            ...
            protected void onBindViewHolder(@NonNull MovieViewHolder viewHolder, final int position, @NonNull GenericProductModel model) {
                ...
                viewHolder.mView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent intent = new Intent(SmartphonesActivity.this, IndividualProductActivity.class);
    ...
    public void viewCart(View view) {
        startActivity(new Intent(SmartphonesActivity.this, CartActivity.class));
        finish();
    }
